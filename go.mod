...
require (
	...
	github.com/jesse0michael/pkg/boot v0.1.0
	github.com/jesse0michael/pkg/config v0.2.0
	github.com/jesse0michael/pkg/http v0.1.0
	github.com/jesse0michael/pkg/logger v0.1.0
